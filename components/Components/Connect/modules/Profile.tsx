...
const Profile: FunctionComponent<ProfileProps> = ({ profile }): JSX.Element => {
  ...
  return (
    <div className="relative w-40 h-10 font-earl text-white border-white border rounded-tl-lg rounded-br-lg flex flex-row px-2 gap-4 items-center justify-center bg-offBlack">
